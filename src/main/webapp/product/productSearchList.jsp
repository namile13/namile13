...
<body>
    ...
    <div class="container">
        ...
        <form id="pagingFrm" name="pagingFrm" action="getProductSearchList.do" method="get">
        	<input type="hidden" id="searchKeyword" name="searchKeyword" value="${paging.cri.searchKeyword}">
